...
Item {
    ...
    property var metadata: {
        'allgames': { color: '#292463', image: 'auto-allgames' },
        'recents': { color: '#906226', vendor: 'past 30 days', image: 'auto-lastplayed' },
        ...
        'pcecd': { color: '#6c8156', vendor: 'NEC', year: '1988-1994', image: 'pce-cd' },
        ...
        'vboy': { color: '#802325', vendor: 'Nintendo', year: '1995-1996', image: 'virtualboy' },
        ...
        // pegasusG
        'atari': { color: '#4f7524', vendor: 'Atari', year: '1977-1992' },
        '动作街机': { color: '#528821', image: 'arcade2' },
        '对战街机': { color: '#025836', image: 'streetfighter' },
        '射击街机': { color: '#049728', image: 'metalslug' },
        '光枪街机': { color: '#258ed1', image: 'auto-lightgun' },
        '飞机街机': { color: '#3b2dd4', image: 'auto-vertical' },
        '赛车街机': { color: '#082f72', image: 'auto-racedriving' },
        '休闲街机': { color: '#1499de', image: 'auto-casual' },
        'nesh': { color: '#c85173', vendor: 'Nintendo', year: '1983-2003' },
        'md hack': { color: '#df535b', vendor: 'Sega', year: '1988-1997', image: 'genh' },
        'pcfx': { color: '#0c46a9', vendor: 'NEC', year: '1994-1998' },
        'sfc hack': { color: '#766f81', vendor: 'Nintendo', year: '1990-2003', image: 'snesh' },
        'sfc-msu1': { color: '#766f81', vendor: 'Nintendo', year: '1990-2003', image: 'snesmsu1' },
    };
}
